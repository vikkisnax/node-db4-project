//3 recipes. on insert they'll get recipe id of 1-3
const recipes = [
...
//ingredients in all 3 recipes. they'll get ingredient id of 1-6
const ingredients = [
...
const steps = [
    ...
    { step_text: 'Add pesto mixed with pasta', step_number: '3', recipe_id: 2},
    //Lemon Chicken
